...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 31, 2024 at 07:16 PM
...
--
ALTER TABLE `book_buyer`
  MODIFY `BBuy_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13300013;

--
-- AUTO_INCREMENT for table `cart`
--
ALTER TABLE `cart`
  MODIFY `Cart_ID` int(20) NOT NULL AUTO_INCREMENT COMMENT 'IDตะกร้า นี้จะเป็นตัวเดียวกับที่เอาข้อมูลไปทำใบเสร็จนะจ๊ะ', AUTO_INCREMENT=2026102329;

--
-- AUTO_INCREMENT for table `order_detail`
--
ALTER TABLE `order_detail`
  MODIFY `Order_ID` int(12) NOT NULL AUTO_INCREMENT COMMENT 'แสดงรายละเรียดของตะกร้าว่ามีหนังสืออะไรถูกเพิ่มเข้ามาบ้าง', AUTO_INCREMENT=2026102334;
